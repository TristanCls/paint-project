...
public class Drawing extends JPanel implements MouseListener, MouseMotionListener {
    ...
    // We also want that the sizes of the sides of the bounding box follow the mouse.
    // So, mouseDragged allows to control the size of the shape by permanently resetting the bounding box between the
    // current position of the mouse and the point of the first click.

    // For the eraser, mouseDragged allows to recreate new white circles on the path of the mouse and thus to make as
    // if we had an eraser.
    ...
    // paintComponent scan every object in the ArrayList to call the draw method on them and thus allows us to draw.
    ...
    // save is the method which allows us to save our project.
    ...
    // open is the method which allows us to open our project.
    public void open() {
        JFileChooser fileChooser = new JFileChooser();
    ...
    // nouveau is the method which allows us to create a new blank project.
